...
class Settings(BaseSettings):
    ...
    chroma_persist_dir: str   = Field("/tmp/chroma_db", env="CHROMA_PERSIST_DIR")
...
# Initialised inside lifespan() after directories are created
